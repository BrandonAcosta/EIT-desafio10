...
*/
// he quitado los metodos para mostrar titulo y autor por consola y alert, ya que no me parecen relevantes en esta parte del ejercicio 
class Libro{
...
//console.log(libro0);
//console.log(document.getElementById("libros"));
//document.getElementById("libros").innerHTML += libro0.getHtmlArticle();
...
const sectionTitle = "<h1>Últimos títulos</h1>";
elemLibrosContainer.innerHTML = sectionTitle + htmlNuevosLibros;
